                ...
                if (loggedInUser) {
                    switch (loggedInUser.name) {
                        case "alladmin":
                            ...
                            break;
                        case "AniqTabiyFan":
                            navigate("/panel-admins-login/aniq-tabiy-fan");
                            break;
                        case "uzrufil":
                            navigate(
                                "/panel-admins-login/uzbek-rus-filologiyasi"
                            );
                            break;
                        case "xorijfilolog":
                            navigate("/panel-admins-login/xorijiy-filologiya");
                            break;
                        case "pedijtfan":
                            navigate("/panel-admins-login/ped-ijt-fan");
                            break;
                        case "amaliyfan":
                            navigate("/panel-admins-login/amaliy-fanlar");
                            break;
                        case "makboshtal":
                            navigate("/panel-admins-login/mak-bosh-talim");
                            break;
                        case "kechki":
    ...
    return (
        <div className=" bg-[#F9FAFB] h-screen">
            <div className="max-w-7xl mx-auto grid md:grid-cols-2 items-center justify-items-center grid-rows-1 pt-40">
                ...
                <form
                    className="w-full max-h-[100rem] bg-white max-w-md gap-y-4 shadow-lg rounded-lg p-10"
                ...
                >
                    ...
                    <div
                        ...
                        } bg-red-600 border-blue-400 text-white py-3 transition-all flex justify-center items-center gap-x-2`}
                    >
